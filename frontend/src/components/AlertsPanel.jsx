  ...
  return (
    <section className="panel-base">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-semibold tracking-wide text-zinc-100">Alert System</h2>
        <span className="inline-flex items-center gap-2 text-xs text-zinc-400">
          <BellRing size={13} /> {alerts.length} active
        </span>
      </div>
      ...
      <div className="max-h-[320px] space-y-2 overflow-auto pr-1">
        ...
        {alerts.length === 0 && (
          <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 text-sm text-emerald-300">
            No active alerts. System operation within baseline envelope.
          </div>
        )}
      </div>
    </section>
